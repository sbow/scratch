...
int main(int argc, char * argv[]) try
{
    ...
    while (true)
    {
        ...
        auto dX = pose_data.translation.x;
        auto dY = pose_data.translation.y;
        auto dZ = pose_data.translation.z;
        auto qW = pose_data.rotation.w;
        auto qX = pose_data.rotation.x;
        auto qY = pose_data.rotation.y;
        auto qZ = pose_data.rotation.z;
        auto vX = pose_data.velocity.x;
        auto vY = pose_data.velocity.y;
        auto vZ = pose_data.velocity.z;
        auto avX = pose_data.angular_velocity.x; // angular velocity
        auto avY = pose_data.angular_velocity.y; // angular velocity
        auto avZ = pose_data.angular_velocity.z; // angular velocity
